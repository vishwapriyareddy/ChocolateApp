    ...
    render(){
        return(
            <Text style={{fontSize:screenHeight*0.0176,marginTop:this.props.topMargin,marginBottom:this.props.bottomMargin,marginLeft:this.props.leftMargin,
                marginRight:this.props.rightMargin,color:this.props.color,textAlign:this.props.textAlign,fontWeight:'500'}}>{this.props.text}
    ...
    render(){
        return(
            <Text style={{fontSize:14,marginTop:this.props.topMargin,marginBottom:this.props.bottomMargin,marginLeft:this.props.leftMargin,
                marginRight:this.props.rightMargin,color:this.props.color,textAlign:this.props.textAlign,width:this.props.width}}>{this.props.text}</Text>
        )
    }
}
export  class BoldRegularText extends Component{
    ...
    render(){
        return(
            <Text style={{fontSize:15,width:this.props.width,fontWeight:'bold',marginTop:this.props.topMargin,marginBottom:this.props.bottomMargin,marginLeft:this.props.leftMargin,
            marginRight:this.props.rightMargin,color:this.props.color,fontFamily:this.props.fontFamily}}>{this.props.text}</Text>
        )
    }
}
    ...
    render(){
        return(
            <Text style={{fontSize:15,marginTop:this.props.topMargin,marginBottom:this.props.bottomMargin,
                ...
                marginRight:this.props.rightMargin,color:this.props.color,width:this.props.width,height:this.props.height}}
...
export  class ExtraRegularText extends Component{
    //15//screenHeight*0.02640
    render(){
        return(
            <Text style={{fontSize:17,fontWeight:'500',marginTop:this.props.topMargin,marginBottom:this.props.bottomMargin,
                marginLeft:this.props.leftMargin,textAlign:this.props.textAlign,
                marginRight:this.props.rightMargin,color:this.props.color,width:this.props.width,height:this.props.height}}
                numberOfLines={this.props.numoflines} 
                >{this.props.text}</Text>
...
export  class LargeText extends Component{
    ...
    render(){
        return(
            <Text style={{fontSize:18,fontWeight:'500',marginTop:this.props.topMargin,marginBottom:this.props.bottomMargin,marginLeft:this.props.leftMargin,
    ...
    render(){
        return(
            <Text style={{fontSize:22,marginTop:this.props.topMargin,marginBottom:this.props.bottomMargin,marginLeft:this.props.leftMargin,
                marginRight:this.props.rightMargin,color:this.props.color,fontWeight:'600',width:this.props.width}}>{this.props.text}</Text>
        )
    }
}